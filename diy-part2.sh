...
sed -i '/uci commit system/i\uci set system.@system[0].hostname='ALPHAXX-R4A'' package/lean/default-settings/files/zzz-default-settings
...
sed -i "s/OpenWrt /吴伟/g" package/lean/default-settings/files/zzz-default-settings
...
sed -i 's/ssid=OpenWrt/ssid=ALPHAXX-R4A/g' package/kernel/mac80211/files/lib/wifi/mac80211.sh
